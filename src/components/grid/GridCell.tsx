...
export const GridCell: React.FC<Props> = React.memo(({ item, column, colWidth, rowIndex, isActive, isCellSelected, hideTotal, isChapterFooter, resourceTotals, onToggleCollapse }) => {
  ...
  const editable = isCellEditable(column.key, rt);
